...
file_type = {"Jpg":10,"txt":14,"docx":2,"py":23}
print(file_type)
print(file_type["docx"])
print("jpg"in file_type)
print("Jpg"in file_type)
file_type["mp4"] = 8
print(file_type)
file_type["txt"] = 5
...
cars_colours = {"black":4,"white":8,"blue":12,"green":6,"yellow":12,"orange":9}
for colour in cars_colours:
    print(colour)
    
for clr,ttl in cars_colours.items():
    print(f"there are {ttl} cars with the {clr} colour")

print(cars_colours.keys())
print(cars_colours.values())
...
print(count_letters("wahyu luna wijaya"))
